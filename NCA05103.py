...
energy = st.sidebar.slider('エネルギー', min_value=0, max_value=1000, step=1, format="%.1f")  # 小数点第1位まで表示
protein = st.sidebar.slider('たんぱく質', min_value=0, max_value=100, step=1, format="%.1f")  # 小数点第1位まで表示
fat = st.sidebar.slider('脂質', min_value=0, max_value=100, step=1, format="%.1f")  # 小数点第1位まで表示
carbs = st.sidebar.slider('炭水化物', min_value=0, max_value=100, step=1, format="%.1f")  # 小数点第1位まで表示
salt = st.sidebar.slider('食塩', min_value=0, max_value=10, step=1, format="%.1f")  # 小数点第1位まで表示
price = st.sidebar.slider('単価', min_value=0, max_value=1000, step=1)  # 単価は整数表示
